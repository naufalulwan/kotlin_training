...
class CategoryFragment : Fragment(), View.OnClickListener {
    ...
    override fun onClick(view: View) {
        if(view.id == R.id.btn_detail_category) {
            ...
            val mBundle = Bundle()
            mBundle.putString(DetailCategoryFragment.EXTRA_NAME, "LifeStyle Fragmented")
//            val name = "LifeStyle Fragment"
            val description = "Kategori ini akan berisi produk-produk life style"
